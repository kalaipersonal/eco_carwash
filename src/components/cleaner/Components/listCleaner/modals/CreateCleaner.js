...
class CreateCleaner extends Component {
	...
	changeDocument() {
		...
		logo = document.getElementById('document').files[0];
				...
				<div className="modal-dialog modal-lg">
					<div className="modal-content">
						<div className="modal-header">
							<h5 className="modal-title">Add Cleaners</h5>
							<button
								type="button"
								className="btn-close"
						...
						<div className="modal-body mx-5">
							<Formik
								...
								onSubmit={(values, onSubmitProps) => {
									// console.log(values);
									let fd = new FormData(document.getElementById("cleaner_form"))
									...
									axios.post("admin/manage_staff/", fd).then(
										(res) => {
											...
											this.props.getCleanerList(true);
